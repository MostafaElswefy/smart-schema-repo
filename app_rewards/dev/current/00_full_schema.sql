[
  {
    ...
    "data": {
      "schema": "app_rewards",
      "version": "1.0.0",
      "exported_at": "2026-05-14T11:01:49.525546+00:00",
  ...
  },
  {
    ...
    "data": [
      ...
      },
      {
        ...
        "schema": "app_rewards",
        "source": "CREATE OR REPLACE FUNCTION app_rewards.deactivate_reward_rule(p_rule_id uuid, p_changed_by uuid DEFAULT NULL::uuid)\n RETURNS jsonb\n LANGUAGE plpgsql\n SECURITY DEFINER\nAS $function$\r\nDECLARE\r\n    v_rule app_rewards.reward_rule_versions%ROWTYPE;\r\nBEGIN\r\n    SELECT * INTO v_rule\r\n    FROM app_rewards.reward_rule_versions\r\n    WHERE id = p_rule_id;\r\n\r\n    IF NOT FOUND THEN\r\n        RETURN jsonb_build_object(\r\n            'success', FALSE,\r\n            'code', 'NOT_FOUND',\r\n            'message', 'Rule not found',\r\n            'details', jsonb_build_array(jsonb_build_object('field', 'rule_id', 'error', 'does not exist'))\r\n        );\r\n    END IF;\r\n\r\n    UPDATE app_rewards.reward_rule_versions\r\n    SET is_active = FALSE, updated_at = NOW(), updated_by = p_changed_by\r\n    WHERE id = p_rule_id;\r\n\r\n    INSERT INTO app_rewards.reward_rule_audit_log (\r\n        rule_id, event_name, action_type, old_version, new_version, changed_by, old_reward_config\r\n    ) VALUES (\r\n        p_rule_id, v_rule.event_name, 'deactivate', v_rule.version, v_rule.version, p_changed_by, v_rule.reward_config\r\n    );\r\n\r\n    RETURN jsonb_build_object(\r\n        'success', TRUE,\r\n        'code', 'DEACTIVATED',\r\n        'message', 'Reward rule deactivated successfully',\r\n        'data', jsonb_build_object(\r\n            'rule_id', p_rule_id,\r\n            'event_name', v_rule.event_name,\r\n            'version', v_rule.version,\r\n            'rule_name', v_rule.rule_name,\r\n            'deactivated_at', NOW()\r\n        )\r\n    );\r\nEND;\r\n$function$\n",
        "returns": "jsonb",
        "language": "plpgsql",
        "arguments": [
          {
