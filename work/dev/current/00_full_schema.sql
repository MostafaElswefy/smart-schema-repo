[
  ...
  },
  {
    ...
    "definition": "CREATE TYPE work.approval_step_assignees AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.approval_workflow_steps AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.approval_workflow_templates AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.contract_approval_workflows AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.contract_approvals AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.contract_links AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.contract_messages AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.contract_ownership_history AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.contract_participants AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.contract_permissions AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.contracts AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.dispute_cases AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.dispute_evidence AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.dispute_hearings AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.dispute_resolution_actions AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.event_outbox AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.event_outbox_processed AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.execution_logs AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.permission_evaluation_log AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.permission_policies AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.policy_assignments AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.policy_conditions AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.state_machines AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.state_transition_history AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.state_transition_rules AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.work_contract_versions AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.work_execution_units AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.work_financial_routes AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.work_ownership_transfers AS ();",
    "sort_order": 1
  },
  {
    "object_type": "TYPE",
    ...
    "definition": "CREATE TYPE work.work_visibility AS ();",
    "sort_order": 1
  },
  {
    "object_type": "ENUM",
  ...
  },
  {
    ...
    "schema_name": "work",
    "object_name": "contract_participants",
    "definition": "CREATE TABLE work.contract_participants (\\n    id uuid NOT NULL DEFAULT gen_random_uuid(),\\n    contract_id uuid NOT NULL,\\n    entity_id uuid NOT NULL,\\n    role work.participant_role NOT NULL,\\n    participation_mode work.participation_mode NOT NULL DEFAULT 'direct'::work.participation_mode,\\n    visibility_scope work.visibility_scope NOT NULL DEFAULT 'internal'::work.visibility_scope,\\n    financial_role work.participant_function,\\n    execution_role work.participant_function,\\n    parent_participant_id uuid,\\n    allocation_percent numeric(5,2),\\n    status work.participant_status NOT NULL DEFAULT 'active'::work.participant_status,\\n    joined_at timestamp with time zone NOT NULL DEFAULT now(),\\n    left_at timestamp with time zone,\\n    metadata jsonb,\\n    created_at timestamp with time zone NOT NULL DEFAULT now(),\\n    updated_at timestamp with time zone NOT NULL DEFAULT now()\\n);",
    "sort_order": 4
  },
  {
    "object_type": "TABLE",
  ...
  },
  {
    ...
    "schema_name": "work",
    "object_name": "work_execution_units",
    "definition": "CREATE TABLE work.work_execution_units (\\n    id uuid NOT NULL DEFAULT gen_random_uuid(),\\n    contract_id uuid NOT NULL,\\n    parent_unit_id uuid,\\n    title text NOT NULL,\\n    description text,\\n    assigned_entity_id uuid,\\n    status work.execution_unit_status NOT NULL DEFAULT 'pending'::work.execution_unit_status,\\n    progress_percent numeric(5,2) NOT NULL DEFAULT 0,\\n    allocated_amount numeric(20,6),\\n    start_at timestamp with time zone,\\n    completed_at timestamp with time zone,\\n    metadata jsonb,\\n    created_at timestamp with time zone DEFAULT now(),\\n    updated_at timestamp with time zone NOT NULL DEFAULT now(),\\n    sequence_no integer,\\n    unit_type work.unit_type DEFAULT 'task'::work.unit_type,\\n    assigned_by_entity_id uuid,\\n    is_milestone boolean DEFAULT false,\\n    milestone_amount numeric(20,6)\\n);",
    "sort_order": 4
  },
  {
    "object_type": "TABLE",
  ...
  },
  {
    ...
    "schema_name": "work",
    "object_name": "work_ownership_transfers",
    "definition": "CREATE TABLE work.work_ownership_transfers (\\n    id uuid NOT NULL DEFAULT gen_random_uuid(),\\n    contract_id uuid NOT NULL,\\n    from_entity_id uuid NOT NULL,\\n    to_entity_id uuid NOT NULL,\\n    transfer_type work.transfer_type NOT NULL,\\n    transfer_scope work.transfer_scope NOT NULL DEFAULT 'full'::work.transfer_scope,\\n    notes text,\\n    effective_at timestamp with time zone NOT NULL DEFAULT now(),\\n    created_at timestamp with time zone DEFAULT now(),\\n    percentage numeric(5,2),\\n    updated_at timestamp with time zone NOT NULL DEFAULT now(),\\n    applied_at timestamp with time zone,\\n    propagation_status text DEFAULT 'pending'::text,\\n    apply_effects boolean DEFAULT true\\n);",
    "sort_order": 4
  },
  {
    "object_type": "TABLE",
  ...
  },
  {
    ...
    "schema_name": "work",
    "object_name": "approval_step_assignees",
    "definition": "ALTER TABLE work.approval_step_assignees OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "approval_workflow_steps",
    "definition": "ALTER TABLE work.approval_workflow_steps OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "approval_workflow_templates",
    "definition": "ALTER TABLE work.approval_workflow_templates OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "contract_approval_workflows",
    "definition": "ALTER TABLE work.contract_approval_workflows OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "contract_approvals",
    "definition": "ALTER TABLE work.contract_approvals OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "contract_links",
    "definition": "ALTER TABLE work.contract_links OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "contract_messages",
    "definition": "ALTER TABLE work.contract_messages OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "contract_ownership_history",
    "definition": "ALTER TABLE work.contract_ownership_history OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "contract_participants",
    "definition": "ALTER TABLE work.contract_participants OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "contract_permissions",
    "definition": "ALTER TABLE work.contract_permissions OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "contracts",
    "definition": "ALTER TABLE work.contracts OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "dispute_cases",
    "definition": "ALTER TABLE work.dispute_cases OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "dispute_evidence",
    "definition": "ALTER TABLE work.dispute_evidence OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "dispute_hearings",
    "definition": "ALTER TABLE work.dispute_hearings OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "dispute_resolution_actions",
    "definition": "ALTER TABLE work.dispute_resolution_actions OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "event_outbox",
    "definition": "ALTER TABLE work.event_outbox OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "event_outbox_processed",
    "definition": "ALTER TABLE work.event_outbox_processed OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "execution_logs",
    "definition": "ALTER TABLE work.execution_logs OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "permission_evaluation_log",
    "definition": "ALTER TABLE work.permission_evaluation_log OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "permission_policies",
    "definition": "ALTER TABLE work.permission_policies OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "policy_assignments",
    "definition": "ALTER TABLE work.policy_assignments OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "policy_conditions",
    "definition": "ALTER TABLE work.policy_conditions OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "state_machines",
    "definition": "ALTER TABLE work.state_machines OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "state_transition_history",
    "definition": "ALTER TABLE work.state_transition_history OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "state_transition_rules",
    "definition": "ALTER TABLE work.state_transition_rules OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "work_contract_versions",
    "definition": "ALTER TABLE work.work_contract_versions OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "work_execution_units",
    "definition": "ALTER TABLE work.work_execution_units OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "work_financial_routes",
    "definition": "ALTER TABLE work.work_financial_routes OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "work_ownership_transfers",
    "definition": "ALTER TABLE work.work_ownership_transfers OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "OWNERSHIP",
    "schema_name": "work",
    "object_name": "work_visibility",
    "definition": "ALTER TABLE work.work_visibility OWNER TO postgres;",
    "sort_order": 10
  },
  {
    "object_type": "RLS",
